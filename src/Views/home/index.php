        ...
        <div class="items-center  lg:flex">
          <div class="w-full text-center lg:w-1/2">
            <div class="w-full flex justify-center flex-col items-center h-50">
              <h1 class="text-3xl text-2xl font-semibold text-dark dark:text-white lg:text-4xl">
                Melhor lugar para escolher seus produtos
              </h1>
              <p class="mt-3 text-dark dark:text-gray-400">Até 50% de desconto em produtos selecionados</p>
